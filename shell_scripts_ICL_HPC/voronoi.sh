...
for PBS_ARRAY_INDEX in $(seq ${start} 1 ${end});
	do cp in.voronoi_cube job$PBS_ARRAY_INDEX
	...
	mpiexec /rds/general/user/mj1516/home/software/lammps-19Mar20/src/lmp_mpi -in job$PBS_ARRAY_INDEX > voronoi_logfile$PBS_ARRAY_INDEX
done
